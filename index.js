...
class MudiExperience {
    ...
    createStyles() {
        ...
        link.href = `https://cdn.jsdelivr.net/gh/RodriguezJose92/ensueno@latest/index.css`; /* custom this path */
                ...
                <div class="containerBtnsActions">
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ensueno@latest/assets/step3.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ensueno@latest/assets/step4.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ensueno@latest/assets/step2.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ensueno@latest/assets/step1.webp">
                                </div>
...
async function verifyDomElement() {
    ...
    let fatherContainer = document.querySelector('#wpgs-gallery');
    let skuElement = document.querySelector('input[name="product_id"]');
    ...
    let skuNumber = skuElement.value;
